...
final class SharePreviewTest extends WebTestCase
{
    ...
    public function testPhotoSharePreviewReturnsOpenGraphHtmlForCrawlers(): void
    {
        ...
        $this->assertStringContainsString(
            'http://localhost:5173/photos/'.$photo->getId()->toRfc4122(),
            $html,
        );
    }
    ...
    public function testPhotoSharePreviewUsesForwardedPublicHost(): void
    {
        ...
        $this->assertResponseIsSuccessful();
        $html = (string) $this->client->getResponse()->getContent();
        $this->assertStringContainsString('https://vite.dias.poa.br/photos/'.$photoId, $html);
        $this->assertStringContainsString(
    ...
    public function testPhotoSharePreviewRedirectsBrowsersToSpaUrl(): void
    {
